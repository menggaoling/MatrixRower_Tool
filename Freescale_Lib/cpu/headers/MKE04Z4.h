...
#if !defined(MKE04Z4_H_)
#define MKE04Z4_H_                               /**< Symbol preventing repeated inclusion */
...
/* APCTL1 Bit Fields */
#define ADC_APCTL1_ADPC_MASK                     0xFFFFFFu
